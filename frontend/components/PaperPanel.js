    ...
    return (
        <div className="w-80 border-l border-[var(--border)] bg-[var(--bg)] p-6 overflow-y-auto">
            <div className="flex justify-between items-start gap-2 mb-2">
                ...
                <button
                    onClick={onClose}
                    className="text-[var(--text-muted)] hover:text-[var(--text)] text-sm shrink-0"
                >
                    X
                </button>
            </div>
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                    {metrics.map(function (pair) {
                        ...
                        return (
                            <span
                                key={label}
                                className="text-xs font-[var(--font-mono)] px-2 py-1 rounded border border-[var(--border)] text-[var(--text-muted)]"
                            >
                                {label + ": "}
